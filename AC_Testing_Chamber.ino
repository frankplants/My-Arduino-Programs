...
void setup(void)
{
  ...
  // create a new file
  char filename[] = "ArtificialChloroplast00.CSV";
  ...
  logfile.println("millis, stamp, datetime, CH4VOLTAGE_01, CH4VOLTAGE_02, CO2VOLTAGE_01, CO2VOLTAGE_02, CH4PPM_01, CH4PPM_02, CO2PPM_01, CO2PPM_02");
  #if ECHO_TO_SERIAL
  Serial.println("millis, stamp, datetime, CH4VOLTAGE_01, CH4VOLTAGE_02, CO2VOLTAGE_01, CO2VOLTAGE_02, CH4PPM_01, CH4PPM_02, CO2PPM_01, CO2PPM_02 ");
  #endif
